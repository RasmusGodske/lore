...
(version, uptime, sandbox runtime, session counts, mirror state), the mirror's state, attempt
log and forced sync, and, from the auth module, user management under `/admin/users`. It
